...
var layoutPhaseSeven = new Phase('Lastly, we want a horizontal navigation bar. Right now the list is stacked, which is a block dislay. Let\'s change the display to inline.', '<input type=\'submit\' value = \'Submit\' id=\'actualButtonOne\'>', null, null, null);

var layoutPhaseEight = new Phase('Great job! We\'ve formatted our page. Let\'s add some color to make it pop.', '<input type=\'submit\' value = \'Move on\' id=\'actualButtonOne\'>', null, null, '<input type=\'submit\' value = \'Reset\' id=\'actualButtonTwo\'>');
